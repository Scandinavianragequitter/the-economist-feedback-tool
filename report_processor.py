...
# Output goes into the Persistent Data folder
...
def fetch_citation_details(citation_id: str) -> Dict[str, Any]:
    ...
    if not conn:
        return {"id": citation_id, "comment_text": "DB Missing", "comment_url": "#"}
...
def parse_and_enrich_report(raw_text: str) -> List[Dict[str, Any]]:
    ...
    for match in pattern.finditer(raw_text):
        ...
        parsed_report.append({"insight": insight_text_raw, "citations": citations})
        last_end = match.end()
